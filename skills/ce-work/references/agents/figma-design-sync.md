...
5. **Precise Implementation**: Make the necessary code changes to fix all identified differences:
   ...
   - Ensure changes follow the project's coding standards from its active instructions/conventions in context
...
- **Code Quality**: Follow the project's active instructions/conventions for project-specific frontend conventions
